...
class AccountDTO(object):
    ...
    def __init__(self, address=None, address_height=None, public_key=None, public_key_height=None, account_type=None, linked_account_key=None, activity_buckets=None, mosaics=None, importance=None, importance_height=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.linked_account_key = linked_account_key
    ...
    @property
    def linked_account_key(self):
        """Gets the linked_account_key of this AccountDTO.  # noqa: E501

        Public key.  # noqa: E501

        :return: The linked_account_key of this AccountDTO.  # noqa: E501
        :rtype: str
        """
        return self._linked_account_key

    @linked_account_key.setter
    def linked_account_key(self, linked_account_key):
        """Sets the linked_account_key of this AccountDTO.

        Public key.  # noqa: E501

        :param linked_account_key: The linked_account_key of this AccountDTO.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and linked_account_key is None:  # noqa: E501
            raise ValueError("Invalid value for `linked_account_key`, must not be `None`")  # noqa: E501

        self._linked_account_key = linked_account_key
