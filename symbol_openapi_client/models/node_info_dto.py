...
class NodeInfoDTO(object):
    ...
    attribute_map = {
        ...
        'network_generation_hash': 'networkGenerationHash',
        'roles': 'roles',
        'port': 'port',
    ...
    def __init__(self, version=None, public_key=None, network_generation_hash=None, roles=None, port=None, network_identifier=None, friendly_name=None, host=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def network_generation_hash(self):
        """Gets the network_generation_hash of this NodeInfoDTO.  # noqa: E501


        :return: The network_generation_hash of this NodeInfoDTO.  # noqa: E501
        :rtype: str
        """
        return self._network_generation_hash

    @network_generation_hash.setter
    def network_generation_hash(self, network_generation_hash):
        """Sets the network_generation_hash of this NodeInfoDTO.


        :param network_generation_hash: The network_generation_hash of this NodeInfoDTO.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and network_generation_hash is None:  # noqa: E501
            raise ValueError("Invalid value for `network_generation_hash`, must not be `None`")  # noqa: E501

        self._network_generation_hash = network_generation_hash
