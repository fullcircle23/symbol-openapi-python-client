...
class BlockDTOAllOf(object):
    ...
    def __init__(self, height=None, timestamp=None, difficulty=None, previous_block_hash=None, transactions_hash=None, receipts_hash=None, state_hash=None, beneficiary_public_key=None, fee_multiplier=None, local_vars_configuration=None):  # noqa: E501
