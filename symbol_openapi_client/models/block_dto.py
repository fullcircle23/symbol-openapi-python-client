...
class BlockDTO(object):
    ...
    def __init__(self, signature=None, signer_public_key=None, version=None, network=None, type=None, height=None, timestamp=None, difficulty=None, previous_block_hash=None, transactions_hash=None, receipts_hash=None, state_hash=None, beneficiary_public_key=None, fee_multiplier=None, local_vars_configuration=None):  # noqa: E501
